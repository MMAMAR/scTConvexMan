...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataname", default="./ziscDesk-single-cell-data/Quake_10x_Limb_Muscle", type=str)
    parser.add_argument("--pretrain_epochs", default=200, type=int)
    parser.add_argument("--maxiter", default=400, type=int)
    parser.add_argument("--threshold_2", default=0.92,type=float)
    parser.add_argument("--threshold_3", default=0.04,type=float)
    parser.add_argument("--overclustering", default=32, type=int)
    ...
    # Pre-training
    model.pre_train(epochs=args.pretrain_epochs, save_path='./resutls/Quake_10x_Limb_Muscle', save='True')
    ...
    # Clustering training
    #Cluster_predicted, acc, nmi, ari = model.alt_train(y, epochs=args.maxiter, centers=centers, overcenters=overcenters, threshold_2=args.threshold_2, threshold_3=args.threshold_3, lr_gen= args.lr_gen, lr_dis=args.lr_dis, lr_clus=args.lr_clus, lr_overclus=args.lr_overclus, W_a=args.W_a, W_c=args.W_c, W_x=args.W_x, W_oc=args.W_oc, n_update=args.n_update, save_path=args.save_path, save=args.save, beta_1=args.beta_1, beta_2=args.beta_2, beta_3=args.beta_3, beta_4=args.beta_4, gen_freq=args.gen_freq, cluster_freq=args.cluster_freq, overcluster_freq=args.overcluster_freq)
    Cluster_predicted, acc, nmi, ari = model.alt_train(y, epochs=args.maxiter, centers=centers, overcenters=overcenters, threshold_2=args.threshold_2, threshold_3=args.threshold_3, lr_gen= 0.0001, lr_dis=0.0001, lr_clus=5e-4, lr_overclus=5e-4, W_a=0.3, W_c=1.5, W_x=1, W_oc=0.5, n_update=16, save_path='./results/Quake_10x_Limb_Muscle', save=True, beta_1=0.95, beta_2=0.95, beta_3=0.95, beta_4=0.95, gen_freq=20, cluster_freq=2, overcluster_freq=2)
